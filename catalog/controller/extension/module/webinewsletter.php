...
class ControllerExtensionModuleWebinewsletter extends Controller {
	...
	public function index($setting) {
		...
		$config_theme = $this->config->get('theme_quipzo3_directory');
		...
		// } else {
		// 	$this->document->addStyle('catalog/view/theme/quipzo3/stylesheet/webinewsletter.css');
		// }
		...
		$this->mdata['mode']        = isset($setting['displaymode']) ? $setting['displaymode'] : "quipzo3";
